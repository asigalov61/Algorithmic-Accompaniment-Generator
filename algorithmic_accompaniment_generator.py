...
Original file is located at
    https://colab.research.google.com/drive/1omCNSo9XVegmVs8seVyjLIv57HqVqX7z

# Algorithmic Accompaniment Generator (ver 1.0)
...
melody_ptc = [n[3] % 12 for n in notes]
...
melody_chunks_overlap = 5 # @param {type:"slider", min:3, max:9, step:1}
...
acc_chunks_f.append(max_acc_chunk[:(len(melody_full) % melody_chunk_length)+1])
